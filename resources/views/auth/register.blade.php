    ...
    <div class="w-full max-w-4xl bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 border border-white/10 animate-slide-up">
        ...
        <div class="hidden lg:flex flex-col justify-center p-8 bg-white/10 border-r border-white/10 relative overflow-hidden animate-slide-left">
            ...
            <div class="relative z-10">
                ...
                <p class="text-gray-300 mt-5 text-base leading-7">
                    Regístrate para comenzar a administrar préstamos,
                    pagos y reportes desde una plataforma moderna y segura.
                </p>
                ...
                <div class="grid grid-cols-3 gap-2 mt-8">
                    <div class="bg-white/10 border border-white/10 rounded-2xl p-3 text-center backdrop-blur hover:scale-105 transition">
                        <h3 class="text-xl font-black text-purple-300">45</h3>
                        <p class="text-[11px] text-gray-400">Préstamos</p>
                    </div>

                    <div class="bg-white/10 border border-white/10 rounded-2xl p-3 text-center backdrop-blur hover:scale-105 transition">
                        <h3 class="text-xl font-black text-purple-300">$85K</h3>
                        <p class="text-[11px] text-gray-400">Pagos</p>
                    </div>

                    <div class="bg-white/10 border border-white/10 rounded-2xl p-3 text-center backdrop-blur hover:scale-105 transition">
                        <h3 class="text-xl font-black text-purple-300">98%</h3>
                        <p class="text-[11px] text-gray-400">Control</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 lg:p-8 flex items-center bg-slate-950/40 backdrop-blur-xl animate-slide-right">
            ...
            <div class="w-full">
                ...
                <p class="text-gray-400 mt-2 mb-6 text-sm">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    {{-- NOMBRE --}}
                    <div>
                        <label for="name" class="block text-sm text-gray-300 mb-1.5">
                            Nombre completo
                        </label>
                    ...
                    {{-- TELEFONO --}}
                    <div>
                        <label for="telefono" class="block text-sm text-gray-300 mb-1.5">
                            Teléfono
                        </label>
                    ...
                    {{-- PASSWORD --}}
                    <div>
                        <label for="password" class="block text-sm text-gray-300 mb-1.5">
                            Contraseña
                        </label>
                    ...
                    {{-- CONFIRMAR PASSWORD --}}
                    <div>
                        <label for="password_confirmation" class="block text-sm text-gray-300 mb-1.5">
