...
<div class="max-w-lg mx-auto">
    <div class="flex items-center gap-3 mb-6">
        <a href__="{{ route('prestamos.show', $prestamo) }}" class="text-gray-400 hover:text-gray-600">← Volver</a>
    ...
    <div class="bg-indigo-50 border border-indigo-100 rounded-xl p-4 mb-6">
        ...
        <p class="text-sm text-indigo-600">Cuota mensual: <strong>${{ number_format($prestamo->monto_cuota,2) }}</strong></p>
        @php
        ...
        <p class="text-sm text-indigo-600 mt-1">
            ...
            — pendiente: <strong>${{ number_format($proximaVencida->cuota_total - $proximaVencida->monto_pagado,2) }}</strong>
        </p>
        @endif
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        <form method="POST" action="{{ route('pagos.store', $prestamo) }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="number" name="monto" step="0.01" min="0.01"
                           value="{{ old('monto', number_format($prestamo->monto_cuota,2,'.','')) }}"
            ...
            <div class="flex gap-3 mt-6 pt-4 border-t">
                ...
                <a href__="{{ route('prestamos.show', $prestamo) }}"
