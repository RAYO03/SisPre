    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50 border-b">
            <tr>
                ...
                <th class="px-4 py-3 text-center text-gray-600 font-medium">Plazo en meses</th>
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-center">{{ $prestamo->plazo_meses }}</td>
                ...
                <td class="px-4 py-3 text-center">
                    ...
                    <a href="{{ route('prestamos.show', $prestamo) }}" class="text-indigo-600 hover:underline">Ver</a>
                </td>
            </tr>
            @empty
            <tr>
